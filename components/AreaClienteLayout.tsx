    ...
    return (
        <div className="min-h-screen bg-background text-slate-100 flex flex-col md:flex-row">
            ...
            <div className="md:hidden flex items-center justify-between p-4 bg-surface border-b border-slate-700">
                <span className="font-bold text-lg text-primary">Área do Cliente</span>
      ...
      `}>
                <div className="p-6">
                    ...
                    <p className="text-xs text-slate-500 uppercase tracking-widest">Portal do Cliente</p>
                </div>

                <nav className="px-4 space-y-2 mt-4">
                    <div className="text-xs font-semibold text-slate-500 uppercase px-3 pt-4 pb-2">Navegação</div>
                    <NavLink to="/area-cliente" end className={navClass}>
